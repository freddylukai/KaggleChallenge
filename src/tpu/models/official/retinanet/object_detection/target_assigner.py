...
class TargetAssigner(object):
    ...
    def assign(self, anchors, groundtruth_boxes, groundtruth_labels=None,
        ...
        Raises:
          ValueError: if anchors or groundtruth_boxes are not of type
            box_list.BoxList
        """
        if not isinstance(anchors, BoxList):
            raise ValueError('anchors must be an BoxList')
        if not isinstance(groundtruth_boxes, BoxList):
        ...
        unmatched_shape_assert = assert_shape_equal(
            combined_static_and_dynamic_shape(groundtruth_labels)[1:],
            combined_static_and_dynamic_shape(
                self._unmatched_cls_target))
        labels_and_box_shapes_assert = assert_shape_equal(
            combined_static_and_dynamic_shape(
    ...
    def _create_regression_targets(self, anchors, groundtruth_boxes, match):
        ...
        matched_gt_boxlist = BoxList(matched_gt_boxes)
        ...
        match_results_shape = combined_static_and_dynamic_shape(
            match.match_results)
